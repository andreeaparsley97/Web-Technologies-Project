...
import BodyDrive from "./bodyDrive.jpeg";
import SIB from "./ShadowsInBlue640.jpeg";
import NoSingleThing from "./NoSingleThing.jpeg";
import SFTF from "./SFTF.jpeg";
import LightWithin from "./LightWithin.jpeg";
import SA from "./SimpleAs.jpeg";
import Versions from "./21Versions.jpeg";
import AML from "./AllMyLove.jpeg";
import bells from "./bells.jpeg";
import Moon from "./bmoon.jpeg";
        ...
        <div className="section">
            ...
            <div className="top-border"></div>
                <section className="wrapper">
                    ...
                    <section className = "main">
                        ...
                        <div className="title"><h1>Bells (System mix / Dream Sequence)</h1></div>
                        <div className="tab">
                            <input id="tab-28" name="tab" type="checkbox"></input>
                            <label for="tab-28">
                                Listen / Buy Digital
                            </label>
            ...
            <div className="top-border"></div>
                <section className="wrapper">
                    ...
                    <section className = "main">
                        ...
                        <div className="title"><h1>Resolve / Prototype Fear</h1></div>
                        <div className="tab">
            ...
            <div className="top-border"></div>
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge</h1></div>
                        <div className="title"><h1>Amor Fati / Renegades</h1></div>
                        <div className="tab">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge</h1></div>
                        <div className="title"><h1>Mind Games / Flashback</h1></div>
                        <div className="tab">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Acre</h1></div>
                        <div className="title"><h1>X / Don't Get Me Started</h1></div>
                        <div className="tab">
                            <input id="tab-32" name="tab" type="checkbox"></input>
                            <label for="tab-32">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge</h1></div>
                        <div className="title"><h1>Blood Moon</h1></div>
                        <div className="tab">
                            <input id="tab-30" name="tab" type="checkbox"></input>
                            <label for="tab-30">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Peverelist</h1></div>
                        <div className="title"><h1>21 Versions / What Your Heart Knows</h1></div>
                        <div className="tab">
                            <input id="tab-26" name="tab" type="checkbox"></input>
                            <label for="tab-26">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Peverelist</h1></div>
                        <div className="title"><h1>Amor Fati (Peverelist remix) / Tilikum (Hodge remix)</h1></div>
                        <div className="tab">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Randomer</h1></div>
                        <div className="title"><h1>Second Freeze / Simple As</h1></div>
                        <div className="tab">
                            <input id="tab-25" name="tab" type="checkbox"></input>
                            <label for="tab-25">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge </h1></div>
                        <div className="title"><h1>Body Drive EP</h1></div>
                        <div className="tab">
                            <input id="tab-20" name="tab" type="checkbox"></input>
                            <label for="tab-20">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Peder Mannerfelt</h1></div>
                        <div className="title"><h1>All My Love</h1></div>
                        <div className="tab">
                            <input id="tab-27" name="tab" type="checkbox"></input>
                            <label for="tab-27">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge </h1></div>
                        <div className="title"><h1>No Single Thing EP</h1></div>
                        <div className="tab">
                            <input id="tab-22" name="tab" type="checkbox"></input>
                            <label for="tab-22">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge </h1></div>
                        <div className="title"><h1>Swing For The Fences</h1></div>
                        <div className="tab">
                            <input id="tab-23" name="tab" type="checkbox"></input>
                            <label for="tab-23">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Randomer</h1></div>
                        <div className="title"><h1>If I Could Stop</h1></div>
                        <div className="tab">
                            <input id="tab-33" name="tab" type="checkbox"></input>
                            <label for="tab-33">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Laurel Halo</h1></div>
                        <div className="title"><h1>Tru / Opal / Light Within You</h1></div>
                        <div className="tab">
                            <input id="tab-24" name="tab" type="checkbox"></input>
                            <label for="tab-24">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge / Shanti Celeste</h1></div>
                        <div className="title"><h1>Soba Dance</h1></div>
                        <div className="tab">
                            <input id="tab-29" name="tab" type="checkbox"></input>
                            <label for="tab-29">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
                ...
                <section className="wrapper">
                    ...
                    <section className = "main">
                        <div className="title"><h1>Hodge </h1></div>
                        <div className="title"><h1>Shadows In Blue</h1></div>
                        <div className="tab">
                            <input id="tab-21" name="tab" type="checkbox"></input>
                            <label for="tab-21">
                                Listen / Buy Digital
                            </label>
                            <div className="tab-content">
